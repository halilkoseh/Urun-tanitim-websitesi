...
<nav class="navbar navbar-expand-lg" id="myNavbar" style="color: black;">
    <div class="container">
      <a class="navbar-brand" href="#anasayfa">
        <img src="images/unnamed-removebg-preview1.png" alt="logo">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link iletisim-link" href="{{ route('anasayfa') }}">
          ...
          <li class="nav-item">
            <a class="nav-link iletisim-link" href="{{ route('flag') }}">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Flag_of_the_United_Kingdom_%283-5%29.svg/640px-Flag_of_the_United_Kingdom_%283-5%29.svg.png" alt="51 Star US Flag" height="16" width="28">
            </a>
        </li>
...
<section class="testimonial section-padding" data-scroll-index='4' id="refrance">
  <div class="container">
    ...
    <div id="slider">
      ...
      <img src="images/arrow-left.png" class="arrow prev" onclick="prevSlide()" alt="Geri">


      <div class="slide">
        <div class="test-img">
          <img src="images/user1.png" alt="TOC Grup" width="100" height="130">
        </div>
        <div class="test-text">
          <h2 class="title">
            <span>TOC Grup</span> <br>
            <a href="https://www.tocgrup.com.tr/" target="_blank" class="slimer">tocgrup.com.tr</a>
          </h2>
          <p>Catering Organizasyon Temizlik Hizmetleri A.Ş.</p>
        </div>
      </div>
      ...
      <div class="slide">
        <div class="test-img">
          <img src="images/channels4_profile-removebg-preview.png   " alt="İkinci Grup" width="100" height="130">
        </div>
        <div class="test-text">
          <h2 class="title">
            <span>MFE Teknoloji </span> <br>
            <a href="https://www.mfeteknoloji.com/" target="_blank" class="slimer">mfeteknoloji.com     </a>
          </h2>
          <p>Başka bir hizmet.</p>
        </div>
      </div>


      <img src="images/arrow-right.png" class="arrow next" onclick="nextSlide()" alt="İleri">
    </div>
  </div>
</section>
...
<footer id="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
            <a href="{{'#service'}}"><img src="images/Ekran_görüntüsü_2024-02-07_230812-removebg-preview.png" alt="" class="img-fluid logo-footer"></a>
        ...
        <div class="col-md-3">
          <div class="useful-link">
            ...
            <div class="use-links">
              ...
              <li><a href="https://www.mfeteknoloji.com/contact"><i class="fa-solid fa-angles-right"></i> Teklif Al</a></li>
              <li><a href="https://extrasistem.com"><i class="fa-solid fa-angles-right"></i> Sisteme Giriş</a></li>
              <li><a href="https://www.mfeteknoloji.com "><i class="fa-solid fa-angles-right"></i> MFE Teknoloji </a></li>
            </div>
          </div>
            ...
            <div class="social-icons">
              <li><a href="https://www.instagram.com/extrasistem/"><i class="fab fa-instagram"></i> Instagram </a></li>
              <li><a href="https://www.tiktok.com/@extrasistem?lang=tr-TR"><i class="fab fa-tiktok"></i> TikTok </a></li>
              <li><a href="https://www.linkedin.com/company/101549029/admin/feed/posts/"><i class="fab fa-linkedin-in"></i>     LinkedIn      </a></li>
        ...
        <div class="col-md-3">
          <div class="address">
            ...
            <div class="address-links">
              <li class="address1"><i class="fa-solid fa-location-dot"></i> Atakent, Mithatpaşa Cd. No:116 İstanbul Ümraniye 34670
              </li>
                 <li><a ><i class="fa-solid fa-phone"></i> (0216) 232 26 56

                 </a></li>
                 <li><a href="mailto:info@mfeteknoloji.com "><i class="fa-solid fa-envelope"></i> info@extrasistem.com</a></li>
            </div>
          </div>
        </div>
            ...
            <div id="cont">
                <div class="footer_center">
                    <table>
                        <tr>
                            <td>
                                <h6><img src="images/unnamed-removebg-preview.png" alt="Image Description" height="50" width="50"></h6>
                            </td>
                            <td>
                                <h6><br><br>👋 Extra Sistem'e Hoş Geldiniz ! 👋 <br> <br> Personel takibi, izin yönetimi, performans değerlendirmesi gibi şirketinizin tüm ihtiyaçlarını tek bir yerden yönetin ve iş verimliliğinizi artırın. Ayrıca, mobil uygulamamızla her zaman erişilebilirsiniz.</h6>
                            </td>
                            <td>
                                <h6><br><br>💼 Extra Sistem Nedir? 💼 <br> <br>Güçlü bir İnsan Kaynakları çözümüdür. Şirketinizin süreçlerini optimize eder, verimliliği artırır ve iş gücü yönetimini kolaylaştırır.</h6>
                            </td>
                            <td>
                                <h6><br><br>🌐 Neden Biz? 🌐 <br> <br>Teknolojiyi kullanarak iş dünyasına değer katmayı hedefliyoruz. Extra Sistem, iş süreçlerinizi zahmetsizleştirir, güvenli ve verimli bir şekilde gerçekleşmesini sağlar.</h6>
                            </td>
                            <td>
                                <h6><br><br>🎯 Neler Sunuyoruz? 🎯<br> <br> İşe Alım ve İstihdam Yönetimi, Personel Bilgi Yönetimi, Performans Yönetimi, Bordro ve İnsan Kaynakları Analitikleri, Eğitim ve Gelişim Takibi. Extra Sistem'i tanımak ve güncel gelişmelerden haberdar olmak için bizi takip edin!</h6>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div class="cookie-popup" id="cookiePopup">
    <p>Sitemizde teknik olarak zorunlu olan çerezler kullanılmakta ve sizlere daha iyi bir hizmet sunabilmek için işlenmektedir. <br>
      Detaylı bilgi için <a href="https://www.kvkk.gov.tr/SharedFolderServer/CMSFiles/fb193dbb-b159-4221-8a7b-3addc083d33f.pdf" style="color:#ACADAF;">KVKK Aydınlatma Metni</a>'ni inceleyebilirsiniz.</p>
